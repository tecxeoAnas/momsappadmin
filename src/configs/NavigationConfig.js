...
const dashBoardNavTree = [{
  ...
  submenu: [
    ...
    // },
          ...
          {
            key: 'welcome',
            path: `${APP_PREFIX_PATH}/dashboards/welcome`,
            title: 'Welcome',
            icon: SmileOutlined,
            breadcrumb: false,
            submenu: [
              {
                key: 'welcome-quick-start',
                path: `${APP_PREFIX_PATH}/dashboards/welcome/quick-start`,
                title: 'MomApp Quick Start',
                icon: '',
                breadcrumb: false,
                submenu: []
              }
          ...
          {
            key: 'extra-pages-user-managment',
          ...
          // {
          //   key: 'extra-pages-studentjourneyplans-list',
          ...
          // },
          {
            key: 'extra-pages-studentjourneyquestions-list',
            path: `${APP_PREFIX_PATH}/dashboards/question-managment`,
            title: 'Questions Managment',
          ...
          {
            key: 'mom-app-center',
            path: `${APP_PREFIX_PATH}/dashboards/mom-app-center`,
            title: 'The Mom App Center',
            icon: AppstoreOutlined,
            breadcrumb: false,
            submenu: [
              {
                key: 'mom-app-center-coming-soon',
              ...
              {
                key: 'extra-pages-course-managment',
                path: `${APP_PREFIX_PATH}/dashboards/course-managment`,
                title: 'TheMOM App Crash Course',
                icon: '',
                breadcrumb: false,
                submenu: []
              },
              {
                key: 'mom-app-center-growth-headquarters',
                path: `${APP_PREFIX_PATH}/dashboards/mom-app-center/growth-headquarters`,
                title: 'Growth Headquarters',
                icon: '',
                breadcrumb: false,
                submenu: []
              },
              {
                key: 'extra-pages-category-managment',
                path: `${APP_PREFIX_PATH}/dashboards/category-managment`,
                title: 'The Mom Reset Room',
                icon: '',
                breadcrumb: false,
                submenu: []
              }
          ...
          {
            key: 'virtual-village',
            path: `${APP_PREFIX_PATH}/dashboards/virtual-village`,
            title: 'Virtual Village',
            icon: TeamOutlined,
            breadcrumb: false,
            submenu: [
              {
                key: 'extra-pages-studentjourneyprompt-list',
              ...
              // {
              //   key: 'virtual-village-community-board',
              //   path: `${APP_PREFIX_PATH}/dashboards/virtual-village/community-board`,
              ...
              // },
              // {
              //   key: 'virtual-village-find-mom-village',
              //   path: `${APP_PREFIX_PATH}/dashboards/virtual-village/find-mom-village`,
              //   title: 'Find your Mom Village',
              //   icon: '',
              //   breadcrumb: false,
              //   submenu: []
              // },
              {
                key: 'virtual-village-private-journal',
              ...
              // {
              //   key: 'virtual-village-upcoming-events',
              //   path: `${APP_PREFIX_PATH}/dashboards/virtual-village/upcoming-events`,
          ...
          {
            key: 'mom-headquarter',
            path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter`,
            title: 'The MOM Headquarter',
            icon: HomeOutlined,
            breadcrumb: false,
            submenu: [
              {
                key: 'mom-headquarter-scheduling',
      ...
      //     path: `${APP_PREFIX_PATH}/edit-clips/12`,
