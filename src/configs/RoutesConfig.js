...
export const protectedRoutes = [
    ...
    {
        key: 'pages.user-list',
        path: `${APP_PREFIX_PATH}/dashboards/user-managment`,
        component: React.lazy(() => import('views/app-views/pages/user-list')),
    },
    {
        key: 'pages.category-list',
        path: `${APP_PREFIX_PATH}/dashboards/category-managment`,
        component: React.lazy(() => import('views/app-views/apps/e-commerce/product-list')),
    },
    {
        key: 'pages.studentjourneyplans-list',
        path: `${APP_PREFIX_PATH}/dashboards/plans-managment`,
         component: React.lazy(() => import('views/app-views/docs')),
        // component: React.lazy(() => import('views/app-views/apps/e-commerce/product-list')),
    },
    {
        key: 'pages.studentjourneyquestions-list',
        path: `${APP_PREFIX_PATH}/dashboards/question-managment`,
         component: React.lazy(() => import('views/app-views/pages/faq')),
        // component: React.lazy(() => import('views/app-views/apps/e-commerce/product-list')),
    },
    {
        key: 'pages.prompt-list',
        path: `${APP_PREFIX_PATH}/dashboards/prompt-managment`,
        component: React.lazy(() => import('views/app-views/pages/prompt-list')),
    },
    {
        key: 'pages.course-list',
        path: `${APP_PREFIX_PATH}/dashboards/course-managment`,
        component: React.lazy(() => import('views/app-views/pages/course-list')),
    },
    {
        key: 'pages.coming-soon',
        path: `${APP_PREFIX_PATH}/dashboards/mom-app-center/coming-soon`,
        component: React.lazy(() => import('views/app-views/pages/coming-soon')),
    },
    {
        key: 'pages.growth-headquarters',
        path: `${APP_PREFIX_PATH}/dashboards/mom-app-center/growth-headquarters`,
        component: React.lazy(() => import('views/app-views/pages/mom-app-center/growth-headquarters')),
    },
    {
        key: 'pages.scheduling-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/scheduling-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/scheduling-hq')),
    },
    {
        key: 'pages.kitchen-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/kitchen-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/kitchen-hq')),
    },
    {
        key: 'pages.wealth-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/wealth-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/wealth-hq')),
    },
    {
        key: 'pages.habits-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/habits-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/habits-hq')),
    },
    {
        key: 'pages.vital-records-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/vital-records-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/vital-records-hq')),
    },
    {
        key: 'pages.business-hq',
        path: `${APP_PREFIX_PATH}/dashboards/mom-headquarter/business-hq`,
        component: React.lazy(() => import('views/app-views/pages/mom-headquarter/business-hq')),
    },
    {
        key: 'pages.support-main',
        path: `${APP_PREFIX_PATH}/dashboards/support/main`,
        component: React.lazy(() => import('views/app-views/pages/support/main')),
    },
    {
        key: 'pages.navigation-video',
        path: `${APP_PREFIX_PATH}/dashboards/support/navigation-video`,
        component: React.lazy(() => import('views/app-views/pages/support/navigation-video')),
    },
    {
        key: 'pages.account-billing',
        path: `${APP_PREFIX_PATH}/dashboards/support/account-billing`,
        component: React.lazy(() => import('views/app-views/pages/support/account-billing')),
    },
    {
        key: 'pages.feedback-form',
        path: `${APP_PREFIX_PATH}/dashboards/support/feedback-form`,
        component: React.lazy(() => import('views/app-views/pages/support/feedback-form')),
    },
    {
        key: 'pages.personal-settings',
        path: `${APP_PREFIX_PATH}/dashboards/support/personal-settings`,
        component: React.lazy(() => import('views/app-views/pages/support/personal-settings')),
    },
    {
        key: 'pages.private-journal',
        path: `${APP_PREFIX_PATH}/dashboards/virtual-village/private-journal`,
        component: React.lazy(() => import('views/app-views/pages/virtual-village/private-journal')),
    },
    {
        key: 'pages.quick-start',
        path: `${APP_PREFIX_PATH}/dashboards/welcome/quick-start`,
        component: React.lazy(() => import('views/app-views/pages/welcome/quick-start')),
    },
    // {
